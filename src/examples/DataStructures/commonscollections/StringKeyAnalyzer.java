...
public class StringKeyAnalyzer extends KeyAnalyzer<String> {
  ...
  public int bitIndex(final String key, final int offsetInBits, final int lengthInBits,
    ...
    if (offsetInBits % LENGTH != 0 || otherOffsetInBits % LENGTH != 0 || lengthInBits % LENGTH != 0
        || otherLengthInBits % LENGTH != 0) {
  ...
  @Override
  public boolean isPrefix(final String prefix, final int offsetInBits, final int lengthInBits,
      final String key) {
