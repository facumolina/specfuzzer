...
public class ListTester0 {
    ...
    public void test49() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "ListTester0.test49");
        DataStructures.List list0 = new DataStructures.List();
        list0.insert((int) (byte) 0);
        list0.insert(9);
        list0.insert(8);
    ...
    public void test50() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "ListTester0.test50");
        DataStructures.List list0 = new DataStructures.List();
        list0.insert((int) (byte) 0);
        list0.insert(9);
        list0.insert((-1));
    ...
    public void test51() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "ListTester0.test51");
        DataStructures.List list0 = new DataStructures.List();
        list0.insert((int) (byte) 0);
        list0.insert(0);
        list0.insert((int) ' ');
    ...
    public void test52() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "ListTester0.test52");
        DataStructures.List list0 = new DataStructures.List();
        list0.insert(100);
        list0.insert((-100));
        list0.insert((-7));
