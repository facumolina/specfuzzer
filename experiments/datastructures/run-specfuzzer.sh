...
java -cp build/classes/:lib/* daikon.Daikon --user-defined-invariant invariant.FuzzedInvariant --grammar-to-fuzz $grammar --fuzzed-invariants $invstofuzz --serialiazed-objects $objects $dtrace
