...
# This script allows to generate invariants for the NodeCachingLinkedList.addLast case study by using a given technique: daikon, specfuzzer, gassert or evospex
...
then
  ...
  echo '  ./run_gassert.sh GASSERT DataStructuresNCLL_addLast 90 daikon.assertions'
fi
